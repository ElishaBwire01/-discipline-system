...
from core.models import DisciplineCategory, DisciplineReport, Student
...
try:
    ...
    if student and teacher and category:
        ...
        if DisciplineReport.objects.count() == 0:
            ...
            print(f"?? Reports already exist: {DisciplineReport.objects.count()}")
    else:
        print("?? Missing required data for sample report")
