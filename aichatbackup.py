...
You are the ultimate assistant for this school's discipline management - use your database access to provide comprehensive, accurate, and helpful responses."""
    ...
    def chat(self, user_message, student_id=None, conversation_history=None):
        ...
        # Answer deterministic read questions from the live ORM before asking an
        # external model. This keeps database facts independent of model context,
        # provider availability, and wording generated by the model.
        try:
            ...
            self.logger.exception("Local database query failed; continuing with validated fallback: %s", exc)
