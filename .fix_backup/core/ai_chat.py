...
class PollinationAIChat:
    ...
    def __init__(self):
        ...
        self.api_url = os.environ.get('SECRET_KEY', 'https://gen.pollinations.ai/v1/chat/completions')
        self.headers = {
...
You are the ultimate assistant for this school's discipline management - use your database access to provide comprehensive, accurate, and helpful responses."""
    ...
    def get_student_data(self, student_id=None, name=None, admission=None):
        ...
        try:
            ...
            data = {
                ...
                os.environ.get('SECRET_KEY', 'days_since_last_incident'): days_since,
        ...
        try:
            response = requests.post(
                ...
                json={
                    ...
                    "messages": messages,
                    "temperature": 0.7,
                    os.environ.get('MAX_TOKENS_VALUE', 'max_tokens'): 1500
                },
                timeout=45
            )
    ...
    def _generate_fallback_response(self, intent, data):
        ...
        if intent['type'] == 'student' and data:
            ...
            if student_data.get(os.environ.get('SECRET_KEY', 'days_since_last_incident')) is not None:
                response += f"• **Days Since Last Incident:** {student_data[os.environ.get('SECRET_KEY', 'days_since_last_incident')]}\n"
