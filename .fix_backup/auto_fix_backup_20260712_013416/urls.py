...
urlpatterns = [
    ...
    path('ai/api/class/<int:stream_id>/recommendations/', views.class_recommendations, name='class_recommendations'),
    ...
    path('reports/summary/', views.export_summary_report, name='export_summary_report'),  # ? NEW
    path('reports/pdf/', views.export_pdf_report, name='export_pdf_report'),  # ? NEW
    
    # ============================================
    # CLASS TEACHER EXPORTS
    # ============================================
    path('class-export-reports/', views.export_class_reports, name='export_class_reports'),  # ? NEW
    path('class-export-student/<int:student_id>/', views.export_class_student_reports, name='export_class_student_reports'),  # ? NEW
