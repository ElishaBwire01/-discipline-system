...
AWS_STORAGE_BUCKET_NAME = os.environ.get('STORAGE_BUCKET', 'profile_pictures')
AWS_S3_ENDPOINT_URL = os.environ.get('STORAGE_URL')
AWS_S3_REGION_NAME = os.environ.get('STORAGE_REGION', 'us-east-1')
