...
urlpatterns = [
    ...
    path("class-summary/", views.class_summary, name="class_summary"),
    ...
    path("role-requests/approve/<int:request_id>/", views.approve_role_request, name="approve_role_request"),
    path("role-requests/reject/<int:request_id>/", views.reject_role_request, name="reject_role_request"),
    path("role-requests/manual/", views.manual_role_assign, name="manual_role_assign"),
    ...
    path("deny-reset/<int:reset_id>/", views.deny_reset, name="deny_reset"),
    ...
    path("api/reset-status/", views.reset_status_api, name="reset_status_api"),
    ...
    path("reports/summary/", views.export_summary_report, name="export_summary_report"),
    path("reports/pdf/", views.export_pdf_report, name="export_pdf_report"),
    path("class-export-reports/", views.export_class_reports, name="export_class_reports"),
    path("class-export-student/<int:student_id>/", views.export_class_student_reports, name="export_class_student_reports"),
